...
function AllGamesPage(props) {
  ...
  return (
    <div className={classes.div}>
      <GameSelectionItem gameName="Top 250 IMDB movies by rank" onPlay={StartGame} src="https://www.listchallenges.com/f/lists/09ed9034-e25b-494c-a04a-e2e18692b5f7.jpg"/>
      ...
      <GameSelectionItem gameName="Top 100 Games of All Time" onPlay={StartGame} src="https://i.ytimg.com/vi/D9lO2uE0ZOE/maxresdefault.jpg"/>
      <GameSelectionItem gameName="Create Custom Game" onPlay={StartGame} src="https://www.pinclipart.com/picdir/big/8-80460_add-plus-plus-sign-circle-png-clipart.png"/>
